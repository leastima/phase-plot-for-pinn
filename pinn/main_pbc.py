...
parser.add_argument('--beta', type=float, default=100000.0, help='beta value that scales the du/dx term. 0 if only doing diffusion.')
...
elif torch.mps.is_available():  # for mac
...
print('Training loss: %e' % (model.final_loss))
print('Best loss: %e' % (model.best_loss))
print('Total cost :', (end_tmp - beg_tmp) / 1e9)
